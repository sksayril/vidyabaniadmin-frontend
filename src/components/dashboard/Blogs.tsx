...
function Blogs() {
  ...
  const deleteBlog = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api.vidyavani.com/api/delete-blog', {
        method: 'POST',
        headers: {
  ...
  const addBlog = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://api.vidyavani.com/api/upload-blog', {
        method: 'POST',
        body: formData,
      });
  ...
  const updateBlog = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send the data to the server
      const response = await fetch('https://api.vidyavani.com/api/update-blog', {
        method: 'POST',
        body: formData,
      });
